...
clojure -A:cljd-dev -M -m cljd.build compile datascript.test.db datascript.test.conn datascript.test.index datascript.test.query datascript.test.transact
dart test -p vm
